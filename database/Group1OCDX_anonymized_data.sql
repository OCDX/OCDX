...
CREATE TABLE `anonymized_data` (
  `anonymized_data_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Indicated whether anyting has been excluded, removed or altered in the dataset in order to protect the identities, integrity and rights of participants.',
  `label` varchar(100) DEFAULT NULL COMMENT 'Indicates oversight type, choose one: IRB, REB, REC',
  `research_object_id` int(10) unsigned NOT NULL,
...
-- Dump completed on 2016-10-31  0:22:26
